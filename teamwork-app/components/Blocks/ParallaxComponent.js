            ...
            <div className="parallaxComponent">
                ...
                <div className="backParalax">
                    ...
                    <div
                        ...
                        style={ bgStyleSecond }
                    />*/}
                    {/*<span className="treangle1"></span>
                    <span className="treangle2"></span>
                    <span className="treangle3"></span>
                    <span className="treangle4"></span>
                    <span className="treangle5"></span>
                    <span className="treangle6"></span>
                    <span className="treangle7"></span>
                    <span className="treangleBord1"></span>
                    <span className="treangleBord2"></span>
                    <span className="treangleBord3"></span>*/}
                </div>
            </div>
        )
    }
